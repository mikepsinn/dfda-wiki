...
description: >-
  A comprehensive guide to robust statistical analysis of treatment effects from
  challenging sparse, irregular time series data with missing values.
published: true
...
metadata:
  media:
    ogImage: /assets/og-images/features/analytics/causal-inference-analysis.jpg
---
