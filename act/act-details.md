...
**Key finding:** The analysis indicates that a global, decentralized FDA platform could [slash per-patient trial costs by up to 80×](../economic-models/dfda-cost-benefit-analysis.md#decentralized-trial-costs-modeled-on-oxford-recovery) and [generate roughly $45 billion in net annual savings](../economic-models/dfda-cost-benefit-analysis.md#overall-savings), resulting in an [ROI of approximately 9:1](../economic-models/dfda-cost-benefit-analysis.md#roi-analysis). For full methodology, assumptions, and detailed breakdowns, see the linked file.
...
(1) The current healthcare and medical research system suffers from critical inefficiencies and inequities:
    ...
    (c) 💰 **Excessive Drug Development Costs:** The average cost to develop a new treatment is approximately $2.6 billion (Tufts CSDD, March 2016) (with some estimates at [$1.6 billion](https://jamanetwork.com/journals/jama/fullarticle/2762311)), these costs are ultimately passed on to patients, insurers, and taxpayers.
