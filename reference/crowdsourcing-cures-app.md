...
![Reminder Inbox Screenshot.jpg](https://static.crowdsourcingcures.org/img/630px-Reminder_Inbox_Screenshot.jpg)

The Curobot app collects and aggregates data on symptoms, diet, sleep, exercise, weather, medication, and anything else from dozens of life-tracking apps and devices. Then, it analyzes this data to reveal hidden factors exacerbating or improving symptoms of chronic illness:  
[https://app.curedao.org/](https://app.curedao.org/)

[https://vimeo.com/526647440](https://vimeo.com/526647440)
...
-   [1 Benefits](#benefits)
-   [2 Features](#features)
    -   [2.1 Data Aggregation](#data-aggregation)
...
![Personal Analytics Dashboard App.png](https://static.crowdsourcingcures.org/img/869px-Personal_Analytics_Dashboard_App.png)
...
![Import Data App.png](https://static.crowdsourcingcures.org/img/593px-Import_Data_App.png)
...
-   Rescuetime â€“ Time Tracking
-   WhatPulse â€“ Keystroke and Mouse Behaviour
-   Fitbit â€“ Sleep Duration, Sleep Quality, Steps, Physical Activity
-   Withings â€“ [Blood Pressure](../reference-databases/blood-pressure.md), Weight, Environmental CO2 Levels, Ambient Temperature
-   Weather â€“ Local Humidity, Cloud Cover, Temperature
-   Facebook â€“ Social Interaction, Likes
-   Github â€“ Code Commits
-   MyFitnessPal â€“ Food and Nutrient Intake
-   MoodPanda â€“ Basic Reported Mood
-   MoodScope â€“ Detailed Reported Mood Using Panas
-   Sleep as Android â€“ Snoring, Deep Sleep, Reported Sleep Rating
-   BodyMedia â€“ Sleep Duration, Sleep Quality, Steps, Physical Activity
-   RunKeeper â€“ Physical Activity
-   MyNetDiary â€“ Food and Nutrient Intake, Vital Signs

### Data Collection

![Track Factors App.png](https://static.crowdsourcingcures.org/img/531px-Track_Factors_App.png)

Rate their symptom severity within a fraction of a second using a unique popup interface.

![Track Symptoms App.png](https://static.crowdsourcingcures.org/img/541px-Track_Symptoms_App.png)

![Create Reminders App.jpg](https://static.crowdsourcingcures.org/img/506px-Create_Reminders_App.jpg)

![Review History and Add Notes.jpg](https://static.crowdsourcingcures.org/img/505px-Review_History_and_Add_Notes.jpg)

![Import Data From Apps and Devices.jpg](https://static.crowdsourcingcures.org/img/517px-Import_Data_From_Apps_and_Devices.jpg)

![Discover Hidden Factors.jpg](https://static.crowdsourcingcures.org/img/517px-Discover_Hidden_Factors.jpg)

![Visualize Your Data.jpg](https://static.crowdsourcingcures.org/img/506px-Visualize_Your_Data.jpg)

### Data Analysis

![Machine Learning.png](https://static.crowdsourcingcures.org/img/688px-Machine_Learning.png)
...
![Platform Overview Diagram.png](https://static.crowdsourcingcures.org/img/507px-Platform_Overview_Diagram.png)
