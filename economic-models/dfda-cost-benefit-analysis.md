...
<a id="full-range-roi-sensitivity-analysis-based-on-section-3-scenarios"></a>
...
---
<a id="appendix-detailed-qaly-calculation-model"></a>
...
| **Generic Drug Substitution**| **1,000 - 10,000+**<a href="#ref_dominant">³</a>           | **Dominant** (Cost-Saving)                | **Dominant**                     | By definition cost-saving when therapeutic equivalence is maintained, with typical savings of 30-80% versus brand-name drugs. ([NIH, 2014](https://pmc.ncbi.nlm.nih.gov/articles/PMC4106542/)) |
