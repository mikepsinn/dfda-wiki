...
description: >-
  A guide for conducting final reference checks for the Supreme Allied
  Commander, War on Disease role, including a bespoke email and form template.
published: true
...
metadata:
  media:
    ogImage: /assets/og-images/careers/reference-check-process.jpg
---
