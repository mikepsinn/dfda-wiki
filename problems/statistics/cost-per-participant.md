...
source: >-
  https://clinicalresearch.io/blog/running-a-study/cost-of-clinical-trials-breakdown/
metadata:
  media:
    ogImage: /assets/og-images/problems/statistics/cost-per-participant.jpg
---
...
This high cost creates significant barriers to medical research. Initiatives like the [Decentralized Institutes of Health (DIH)](https://manual.warondisease.org/knowledge/solution/dih) aim to address this by establishing new financial frameworks to subsidize patient costs and accelerate research.
