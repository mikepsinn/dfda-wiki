...
description: >-
  An experimental protocol for crowdsourcing longevity research for a random
  intervention and collecting outcome data to characterize the participant's
  overall health status using affordable and valuable collection methods
published: true
...
metadata:
  media:
    ogImage: >-
      /assets/og-images/clinical-trials/protocols/crowdsourcing-longevity-research.jpg
---
