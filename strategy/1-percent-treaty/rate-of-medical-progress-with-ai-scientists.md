...
For more on the economic impact of automating research, see [using AI to automate clinical research](value-of-automating-research.md). For the treaty that would enable this, see the [1% Treaty](/strategy/1-percent-treaty/).
