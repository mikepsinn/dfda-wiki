...
description: >-
  By upgrading FDA.gov to automate the pragmatic trial approach of the Oxford
  Recovery Trial, Transforming the system has the potential for an **80X
  acceleration in medical progress** reducing the cost of medical research from
  $48k/patient to $500/patient.
published: true
...
metadata:
  media:
    ogImage: /assets/og-images/regulatory/petition.jpg
---
