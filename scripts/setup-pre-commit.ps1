# Setup pre-commit hook for link validation (PowerShell)
...
Write-Host "   The hook will validate links in staged markdown files before each commit." -ForegroundColor Gray
